...
import math #importing math module to do math functions
def prime(num):  # defining a prime function which one argument
    """prime(num)->This function takes one argument as and return True num is prime else
    return False"""
    def check(num): #defining a fucnction called check whic 
        if prime.i < 0 :
