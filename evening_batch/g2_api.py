...
lat = d2['result']['geometry']['location']['lat']
lng = d2['result']['geometry']['location']['lng']

url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+lat","+lng+"&radius=500&types="+input("Enter type - ")+"&"+"name="+input("\nWhat to search - ")+"&key=AIzaSyBy6pJs4DApRua7iNF0T4DNSksHLoshyf8"
